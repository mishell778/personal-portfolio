...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(c) {
      ...
      let _gl = c.getContext("webgl2", params);
      const isWebGL2 = !!_gl;
      if (!isWebGL2) {
        _gl = c.getContext("webgl", params) || c.getContext("experimental-webgl", params);
      }
      if (!_gl) return { gl: null, ext: null };
    ...
    function supportRenderTextureFormat(_gl, internalFormat, format, type) {
      ...
      const status = _gl.checkFramebufferStatus(_gl.FRAMEBUFFER);
    ...
    function compileShader(type, source, keywords) {
      const _source = addKeywords(source, keywords);
